...
import { changePasswordHandler, createUserHandler, deleteUserHandler, forgotPasswordHandler } from './controller/user.controller';
...
import { changePasswordSchema, createUserSchema, deleteUserSchema, forgotPasswordSchema } from './schema/user.schema';
...
function routes(app: Express) {
  ...
  app.put('/api/forgotPassword', validateResource(forgotPasswordSchema), forgotPasswordHandler); //Passwort vergessen
